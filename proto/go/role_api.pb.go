...
func (x *RoleFindManyResponse) Reset() {
	*x = RoleFindManyResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_role_api_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RoleFindManyResponse) Descriptor() ([]byte, []int) {
	return file_role_api_proto_rawDescGZIP(), []int{9}
}
...
var file_role_api_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1b, 0x0a, 0x05, 0x72, 0x6f, 0x6c, 0x65, 0x73, 0x18, 0x01, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x05, 0x2e, 0x52, 0x6f, 0x6c, 0x65, 0x52, 0x05, 0x72, 0x6f, 0x6c, 0x65,
	0x73, 0x22, 0x33, 0x0a, 0x14, 0x52, 0x6f, 0x6c, 0x65, 0x46, 0x69, 0x6e, 0x64, 0x4d, 0x61, 0x6e,
	0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1b, 0x0a, 0x05, 0x72, 0x6f, 0x6c,
	0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x05, 0x2e, 0x52, 0x6f, 0x6c, 0x65, 0x52,
	0x05, 0x72, 0x6f, 0x6c, 0x65, 0x73, 0x42, 0x0f, 0x5a, 0x0d, 0x2e, 0x2f, 0x67, 0x6f, 0x3b, 0x70,
...
var file_role_api_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_role_api_proto_goTypes = []interface{}{
	...
	(*RoleFindAllResponse)(nil),  // 8: RoleFindAllResponse
	(*RoleFindManyResponse)(nil), // 9: RoleFindManyResponse
	(*Role)(nil),                 // 10: Role
	(*UUID)(nil),                 // 11: UUID
}
var file_role_api_proto_depIdxs = []int32{
	10, // 0: RoleCreateResponse.role:type_name -> Role
	11, // 1: RoleUpdateRequest.id:type_name -> UUID
	10, // 2: RoleUpdateResponse.role:type_name -> Role
	11, // 3: RoleDeleteRequest.id:type_name -> UUID
	11, // 4: RoleFindOneRequest.id:type_name -> UUID
	10, // 5: RoleFindOneResponse.role:type_name -> Role
	10, // 6: RoleFindAllResponse.roles:type_name -> Role
	10, // 7: RoleFindManyResponse.roles:type_name -> Role
...
func file_role_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_role_api_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
