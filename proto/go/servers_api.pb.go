...
type ServersCreateRequest struct {
	...
	LogicalCores uint32 `protobuf:"varint,6,opt,name=logical_cores,json=logicalCores,proto3" json:"logical_cores,omitempty"`
	Port         *Port  `protobuf:"bytes,7,opt,name=port,proto3" json:"port,omitempty"`
}
...
func (x *ServersCreateRequest) GetGame() *Game {
	if x != nil {
		return x.Game
	}
	return nil
...
func (x *ServersCreateRequest) GetOwner() *User {
	if x != nil {
		return x.Owner
	}
	return nil
...
func (x *ServersCreateRequest) GetNode() *Node {
	if x != nil {
		return x.Node
	}
	return nil
...
func (x *ServersCreateRequest) GetRam() uint32 {
	if x != nil {
		return x.Ram
	}
	return 0
...
func (x *ServersCreateRequest) GetStorage() uint32 {
	if x != nil {
		return x.Storage
	}
	return 0
...
var file_servers_api_proto_rawDesc = []byte{
	...
	,
	...
	0x76, 0x65, 0x72, 0x73, 0x22, 0x17, 0x0a, 0x15, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x73, 0x46,
	0x69, 0x6e, 0x64, 0x41, 0x6c, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x3b, 0x0a,
	0x16, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x73, 0x46, 0x69, 0x6e, 0x64, 0x41, 0x6c, 0x6c, 0x52,
...
var file_servers_api_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_servers_api_proto_goTypes = []interface{}{
	...
	(*ServersDeleteRequest)(nil),   // 4: ServersDeleteRequest
	(*ServersDeleteResponse)(nil),  // 5: ServersDeleteResponse
	(*Game)(nil),                   // 6: Game
	(*User)(nil),                   // 7: User
	(*Node)(nil),                   // 8: Node
	(*Port)(nil),                   // 9: Port
...
var file_servers_api_proto_depIdxs = []int32{
	6,  // 0: ServersCreateRequest.game:type_name -> Game
	7,  // 1: ServersCreateRequest.owner:type_name -> User
	8,  // 2: ServersCreateRequest.node:type_name -> Node
	9,  // 3: ServersCreateRequest.port:type_name -> Port
	10, // 4: ServersCreateResponse.servers:type_name -> Server
	10, // 5: ServersFindAllResponse.servers:type_name -> Server
	11, // 6: ServersDeleteRequest.id:type_name -> UUID
