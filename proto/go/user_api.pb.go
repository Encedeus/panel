...
type UserFindWithRoleResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *UserFindWithRoleResponse) Reset() {
	*x = UserFindWithRoleResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *UserFindWithRoleResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserFindWithRoleResponse) ProtoMessage() {}

func (x *UserFindWithRoleResponse) ProtoReflect() protoreflect.Message {
	mi := &file_user_api_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserFindWithRoleResponse.ProtoReflect.Descriptor instead.
func (*UserFindWithRoleResponse) Descriptor() ([]byte, []int) {
	return file_user_api_proto_rawDescGZIP(), []int{9}
}

func (x *UserFindWithRoleResponse) GetUsers() []*User {
	if x != nil {
		return x.Users
	}
	return nil
...
var file_user_api_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x52, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x22, 0x37, 0x0a, 0x18, 0x55, 0x73, 0x65,
	0x72, 0x46, 0x69, 0x6e, 0x64, 0x57, 0x69, 0x74, 0x68, 0x52, 0x6f, 0x6c, 0x65, 0x52, 0x65, 0x73,
	...
	0x72, 0x73, 0x22, 0x81, 0x01, 0x0a, 0x19, 0x55, 0x73, 0x65, 0x72, 0x43, 0x68, 0x61, 0x6e, 0x67,
	...
	,
	...
	0x55, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x1c, 0x0a, 0x1a, 0x55, 0x73, 0x65, 0x72,
	0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x55, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x72, 0x0a, 0x16, 0x55, 0x73, 0x65, 0x72, 0x43, 0x68,
	...
	0x52, 0x08, 0x6e, 0x65, 0x77, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x19, 0x0a, 0x17, 0x55, 0x73,
	0x65, 0x72, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0f, 0x5a, 0x0d, 0x2e, 0x2f, 0x67, 0x6f, 0x3b, 0x70, 0x72,
...
var file_user_api_proto_goTypes = []interface{}{
	...
	(*UserFindWithRoleResponse)(nil),   // 9: UserFindWithRoleResponse
	(*UserChangePasswordRequest)(nil),  // 10: UserChangePasswordRequest
	(*UserChangePasswordResponse)(nil), // 11: UserChangePasswordResponse
	(*UserChangeUsernameRequest)(nil),  // 12: UserChangeUsernameRequest
	(*UserChangeUsernameResponse)(nil), // 13: UserChangeUsernameResponse
	(*UserChangeEmailRequest)(nil),     // 14: UserChangeEmailRequest
	(*UserChangeEmailResponse)(nil),    // 15: UserChangeEmailResponse
	(*UUID)(nil),                       // 16: UUID
	(*User)(nil),                       // 17: User
}
var file_user_api_proto_depIdxs = []int32{
	16, // 0: UserCreateRequest.role_id:type_name -> UUID
	17, // 1: UserCreateResponse.user:type_name -> User
	16, // 2: UserUpdateRequest.user_id:type_name -> UUID
	16, // 3: UserUpdateRequest.role_id:type_name -> UUID
	17, // 4: UserUpdateResponse.user:type_name -> User
	16, // 5: UserDeleteRequest.user_id:type_name -> UUID
	16, // 6: UserFindOneRequest.user_id:type_name -> UUID
	17, // 7: UserFindOneResponse.user:type_name -> User
	17, // 8: UserFindManyResponse.users:type_name -> User
	17, // 9: UserFindWithRoleResponse.users:type_name -> User
	16, // 10: UserChangePasswordRequest.user_id:type_name -> UUID
	16, // 11: UserChangeUsernameRequest.user_id:type_name -> UUID
	16, // 12: UserChangeEmailRequest.user_id:type_name -> UUID
...
func file_user_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_user_api_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UserFindWithRoleResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
